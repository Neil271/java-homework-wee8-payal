 ...
 */
public class Programme_20_Main {
    public static void main(String[] args) {
        // Create a Rectangle object
        Programme_20_Rectangle rectangle = new Programme_20_Rectangle(5, 10);
        System.out.println("rectangle.width= " + rectangle.getWidth()); // Expected output: 5.0
        System.out.println("rectangle.length= " + rectangle.getLength()); // Expected output: 10.0
        System.out.println("rectangle.area= " + rectangle.getArea()); // Expected output: 50.0

        // Create a Cuboid object
        Programme_20_Cuboid cuboid = new Programme_20_Cuboid(5, 10, 5);
        System.out.println("cuboid.width= " + cuboid.getWidth()); // Expected output: 5.0
        System.out.println("cuboid.length= " + cuboid.getLength()); // Expected output: 10.0
        System.out.println("cuboid.area= " + cuboid.getArea()); // Expected output: 50.0
        System.out.println("cuboid.height= " + cuboid.getHeight()); // Expected output: 5.0
        System.out.println("cuboid.volume= " + cuboid.getVolume()); // Expected output: 250.0
    }
}
