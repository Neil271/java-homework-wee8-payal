 ...
 */
public class Programme_17_Main {
    public static void main(String[] args) {
        // Test example 1
        Programme_17_Carpet carpet = new Programme_17_Carpet(3.5);
        Programme_17_Floor floor = new Programme_17_Floor(2.75, 4.0);
        Programme_17_Calculator calculator = new Programme_17_Calculator(floor, carpet);
        System.out.println("total= " + calculator.getTotalCost()); // Expected output: 38.5

        // Test example 2
        carpet = new Programme_17_Carpet(1.5);
        floor = new Programme_17_Floor(5.4, 4.5);
        calculator = new Programme_17_Calculator(floor, carpet);
        System.out.println("total= " + calculator.getTotalCost()); // Expected output: 36.45
    }
}
